...
/// <remarks>
/// A transport of its own because IronHive's embedding abstraction has no place for provider-specific request fields,
/// so <see cref="OpenAICompatibleOptions.ExtraBody"/> would reach chat requests but not embedding requests.
/// </remarks>
// TODO(upstream): replace with an adapter over IronHive's IEmbeddingGenerator once its requests can carry extra body
// fields; remove this transport then.
